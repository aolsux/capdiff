...
#ifndef SIMULATIONEVALUATOR_CPP_
#define SIMULATIONEVALUATOR_CPP_
...
SimulationEvaluator<B,F>::SimulationEvaluator(const Simulator<B,F> &_sim, unsigned _samples) :
	simulator		(_sim),
...
template<typename B,typename F>
SimulationEvaluator<B,F>::~SimulationEvaluator()
{
	//nothing to do yet...
}

template<typename B,typename F>
void SimulationEvaluator<B,F>::evaluateTrajectories()
{
...
template<typename B,typename F>
void SimulationEvaluator<B,F>::getMagnetizationDistribution(double spaceres, unsigned timeres)
{
...
template<typename B,typename F>
void SimulationEvaluator<B,F>::preparePeriodicMultiSpinEcho(unsigned number, unsigned periodResolution)
{
 ...
 */
template<typename B,typename F>
void SimulationEvaluator<B,F>::addSpinEchoSequence(vector<double> sequence)
{
...
#endif /* SIMULATIONEVALUATOR_CPP_ */
